...
based on a configurable number of approvers. While users cannot approve their
own requests, Teleport does support [automatic reviews](./automatic-reviews.mdx)
for access request workflows without requiring manual approval.
