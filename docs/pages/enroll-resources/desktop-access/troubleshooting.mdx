...
to connect with Teleport to review log entries.
...
- Ensure that the issuing CA certificate for the KDC certificates is also present
  in the NTAuth store of the domain contoller.
...
Services Logs, Microsoft, Windows, CAPI2, Operational. Enable this Event Log and
attempt to connect with Teleport to review log entries.
