...
func newCreateAuditEvent(ctx context.Context, created *vnet.VnetConfig) apievents.AuditEvent {
...
func newUpdateAuditEvent(ctx context.Context, updated *vnet.VnetConfig) apievents.AuditEvent {
...
func newDeleteAuditEvent(ctx context.Context, deleted *vnet.VnetConfig) apievents.AuditEvent {
	name := ""
	if deleted != nil {
